...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Firebase.Database.IChildEventListenerImplementor, Xamarin.Firebase.Database", ChildEventListenerImplementor.class, __md_methods);
	}


	public ChildEventListenerImplementor ()
	{
		super ();
		if (getClass () == ChildEventListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Firebase.Database.IChildEventListenerImplementor, Xamarin.Firebase.Database", "", this, new java.lang.Object[] {  });
		}
	}
