...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Firebase.Database.DatabaseReference+ICompletionListenerImplementor, Xamarin.Firebase.Database", DatabaseReference_CompletionListenerImplementor.class, __md_methods);
	}


	public DatabaseReference_CompletionListenerImplementor ()
	{
		super ();
		if (getClass () == DatabaseReference_CompletionListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Firebase.Database.DatabaseReference+ICompletionListenerImplementor, Xamarin.Firebase.Database", "", this, new java.lang.Object[] {  });
		}
	}
