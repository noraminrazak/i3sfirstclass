...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Firebase.Database.IValueEventListenerImplementor, Xamarin.Firebase.Database", ValueEventListenerImplementor.class, __md_methods);
	}


	public ValueEventListenerImplementor ()
	{
		super ();
		if (getClass () == ValueEventListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Firebase.Database.IValueEventListenerImplementor, Xamarin.Firebase.Database", "", this, new java.lang.Object[] {  });
		}
	}
