...
namespace SmartSchoolsV2.Controls
{
    public partial class FloatingLabelInput : ContentView
    {
        ...
        public static readonly BindableProperty ClearButtonVisibilityProperty = BindableProperty.Create(nameof(ClearButtonVisibility), typeof(ClearButtonVisibility), typeof(FloatingLabelInput), ClearButtonVisibility.Never);
