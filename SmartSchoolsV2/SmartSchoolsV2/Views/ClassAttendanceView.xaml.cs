...
namespace SmartSchoolsV2.Views
{
    ...
    public partial class ClassAttendanceView : ContentView
    {
        ...
        public static Command LoadClassDailyAttendancePercentage { get; set; }
        ...
        public ClassAttendanceView()
        {
            ...
            LoadClassDailyAttendancePercentage = new Command(async () => await ClassDailyAttendancePercentage());
        ...
        async void OnLeftArrowClicked(object s, DateTimeEventArgs e)
        {
            ...
            await ClassDailyAttendancePercentage();
        }
        ...
        async void OnDateClicked(object s, DateTimeEventArgs e)
        {
            ...
            ClassAttendancePage page = new ClassAttendancePage(Settings.selectedSchoolId, Settings.selectedSchoolName, Settings.selectedClassId, Settings.selectedClassName, _selectedDate);
            await Navigation.PushAsync(page);
        }

        public async Task ClassDailyAttendancePercentage()
        {
            if (conn.IsConnected() == true)
            {
                ...
                {
                    ShowLoadingPopup();
                    var t = srvc.PostSchoolClassDailyAttendancePercentage(Settings.selectedSchoolId, Settings.selectedClassId, _monthYear.ToString("MM-yyyy"));
