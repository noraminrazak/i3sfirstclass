...
namespace SmartSchoolsV2.Views
{
    ...
    public partial class StudentPage2 : ContentPage
    {
        ...
        public StudentPage2(int student_id, int profile_id, string full_name, string photo_url, int school_id, string school_name, int school_type_id,
            int class_id, string class_name)
        {
            ...
            imgOuting.GestureRecognizers.Add(tapGestureRecognizer4);
        ...
        protected override void OnAppearing()
        {
            ...
            {
                StudentOutingRequestView.LoadStudentOutingRequest.Execute(null);
            }
        }
