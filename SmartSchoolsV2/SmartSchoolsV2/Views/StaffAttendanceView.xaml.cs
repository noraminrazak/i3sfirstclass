...
namespace SmartSchoolsV2.Views
{
    ...
    public partial class StaffAttendanceView : ContentView
    {
        Connection conn = new Connection();
        ServiceWrapper srvc = new ServiceWrapper();
        public string requestUrl = Settings.requestUrl;
        CultureInfo ci = new CultureInfo(Settings.cultureInfo);
        public static Command LoadStaffAttendanceMonthly { get; set; }
        public int _m;
        public int _y;
        ...
        public StaffAttendanceView()
        {
            ...
            LoadStaffAttendanceMonthly = new Command(async () => await StaffMonthlyAttendance());
        ...
        public async Task StaffMonthlyAttendance()
        {
            if (conn.IsConnected() == true)
            {
                try
                {
                    ...
                    var t = srvc.PostStaffMonthlyAttendance(Settings.schoolId, Settings.staffId, _monthYear.ToString("MM-yyyy"));
        ...
        public async Task StaffDailyAttendance()
        {
            if (conn.IsConnected() == true)
            {
                try
                {
                    ...
                    var t = srvc.PostStaffDailyAttendance(Settings.schoolId, Settings.staffId, _selectedDate.ToString("dd-MM-yyyy"));
                    string jsonStr = await t;
                    StudentMonthlyAttendanceProperty response = JsonConvert.DeserializeObject<StudentMonthlyAttendanceProperty>(jsonStr);
                    if (response.Success == true)
                    {
