...
namespace SmartSchoolsV2.Views
{
    ...
    public partial class ClubPage : ContentPage, INotifyPropertyChanged
    {
        ...
        public ClubPage(int relationship_id, int profile_id, int club_id, string club_name, int school_id, 
        ...
        void OnPositionChanged(object sender, PositionChangedEventArgs e)
        {
            ...
            {
                ClubAttendanceView.LoadClubDailyAttendancePercentage.Execute(null);
