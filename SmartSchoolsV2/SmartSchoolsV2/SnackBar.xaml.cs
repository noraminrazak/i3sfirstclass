...
namespace SmartSchoolsV2
{
    ...
    public partial class SnackBar : TemplatedView
    {
        ...
        public static readonly BindableProperty CloseButtonTextProperty = BindableProperty.Create("CloseButtonText", typeof(string), typeof(SnackBar), AppResources.CloseText);
